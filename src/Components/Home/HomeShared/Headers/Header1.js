...
import logo2 from "../../../../styles/images/header-logo2.png";
const Header1 = () => {
  const [buyClickBtn, setBuyClickBtn] = useState(false);
  const [rentClickBtn, setrentClickBtn] = useState(false);
                ...
                <div class="home_adv_srch_opt">
                  <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    <li class="nav-item">
                      <a
                        class={`${
                          buyClickBtn ? "nav-link active " : "nav-link  "
                        }`}
                        id="pills-home-tab"
                        data-toggle="pill"
                        href="#pills-home"
                    ...
                    <li class="nav-item">
                      <a
                        class={`${
                          rentClickBtn ? "nav-link  active" : "nav-link  "
                        }`}
                        ...
                        aria-selected="false"
                        onClick={() => {
                          setBuyClickBtn(false);
                          setrentClickBtn(true);
                        }}
                      >
                        Rent
                      </a>
                                    ...
                                    <div class="col-lg-1 col-xl-2">
                                      <div class="mega_dropdown_content_closer">
                                        <h5 class="text-thm text-right mt15">
                                          <span id="hide_advbtn" class="curp">
                                            Hide
                                          </span>
                                        </h5>
                                      </div>
                      ...
                      <div class="home1-advnc-search">
                        <ul class="h1ads_1st_list mb0">
                          ...
                          <li class="custome_fields_520 list-inline-item">
                            <div class="navbered">
                              <div class="mega-dropdown">
                                <span id="show_advbtn2" class="dropbtn">
                                  Advanced{" "}
                                  <i class="flaticon-more pl10 flr-520"></i>
                                </span>
                                <div class="dropdown-content">
                                  ...
                                  <div class="row p15 pt0-xsd">
                                    ...
                                    <div class="col-lg-1 col-xl-2">
                                      <div class="mega_dropdown_content_closer">
                                        <h5 class="text-thm text-right mt15">
                                          <span id="hide_advbtn2" class="curp">
                                            Hide
                                          </span>
                                        </h5>
                                      </div>
